...
class ContactServiceTest {
    ...
    @BeforeEach
    void setUp() {
        contact = new Contact(1L, "Muskan", "muskanvishwakarma06942@gmail.com", "9997970629");
        contactDTO = new ContactDTO("Muskan", "muskanvishwakarma06942@gmail.com", "9997970629");
    }
    ...
    void testCreateAddressBookEntry() {
        ...
        assertEquals("Muskan", createdContact.getName());
    }
    ...
    void testGetEntryById_Found() {
        ...
        assertEquals("Muskan", retrievedContact.getName());
    }
